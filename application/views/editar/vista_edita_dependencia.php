  				...
  				<table id="tabla" class="display" cellspacing="0" width="100%">
  					<thead>
	  					<tr>
	  						...
	  						<th><center>Alumnos que acepta</center></th>
					...
					<?php 
						if (count($dependencias)>0)
						{
							...
							{								
								echo "<tr>";
								echo "<td class='success' height='100%'>".$dependencias->Nombre."</td>";
								echo "<td class='success' height='100%'>".$dependencias->CantidadMaxAlumnos."</td>";
								echo "<td class='success' align='center' height='100%'>";
								?>
								<form action="<?php echo site_url('controlador_inicio/dependencia');?>?id=<?php echo $dependencias->idDependencia?>" method="post"> <!--Envía el id del dato que se modificará-->
								<?php
